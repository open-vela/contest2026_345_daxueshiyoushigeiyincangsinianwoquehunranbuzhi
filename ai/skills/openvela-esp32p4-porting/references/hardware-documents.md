...
| --- | --- | --- |
| `ESP32_P4X_C5_Function_EV_board-2.0-schematics.pdf` | Exact board wiring, connector pins, nets, pull resistors, rails, fitted/NC parts | `ceff97cf20e86b30480f8410d285f411108b4402beb2f63c1a0559f5119b9bd9` |
...
- C5/network/storage/audio: schematic sheets 4-6 and every shared rail,
  reset, wakeup, SDIO/RMII/I2S/I2C net involved.

## Verified board 2.0 facts
...
- The BOOT button pulls `ESP_BOOT` low; `ESP_BOOT` is connected to the
  `GPIO35_BOOTMODE` strapping network.
...
- GPIO7/GPIO8 connect through populated 0 Ω resistors R194/R190 to shared
  `ESP_I2C_SCL`/`ESP_I2C_SDA`. Do not short them for a GPIO loopback even
  though both also appear on J1.
- GPIO20/GPIO21 connect through R40/R33 to `CNN_GPIO20`/`CNN_GPIO21` and J1,
